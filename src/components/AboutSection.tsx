...
export default function AboutSection() {
  ...
  return (
    <section
      id="about"
      className="py-24 bg-background relative overflow-hidden border-t border-border/40"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="group glass-panel p-6 rounded-3xl border border-border">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Rapid development cycles engineered for seamless, on-time
                    project launches.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-8">
                <div className="group glass-panel p-6 rounded-3xl border border-border">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Combining technology with data-driven marketing to maximize
                    ROI.
                  </p>
                </div>
                <div className="rounded-3xl overflow-hidden border border-border shadow-2xl">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="mt-5 text-base text-gray-300 leading-relaxed">
              ZTA Lab is a creative technology agency founded by a team of
              passionate engineers and digital strategists. We specialize in
              building scalable digital solutions—from modern websites to
              full-stack applications—combined with result-oriented marketing
              strategies.
            </p>
            ...
            <div className="mt-4 p-4 rounded-2xl bg-card/90 border border-primary/30">
              ...
              <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
                We believe in innovation, precision, and long-term partnerships.
                Whether you are a startup or an established business, we help
                you grow in the digital world.
              </p>
            </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5 max-w-md">
                    To become a leading digital solutions provider by delivering
                    innovative, efficient, and scalable technology services
                    worldwide.
                  </p>
                </div>
                <a
